...
const QuestionA: React.FC = () => {
  ...
  const examSection: ExamSection = {
    ...
    questions: [
      {
        question: "A bakery sells 120 loaves of bread per day. If they want to increase their sales by 25%, how many loaves should they aim to sell?",
  ...
  const handleBack = () => {
    navigate("/student/technicalassessment/overview");
  };
    ...
    <div className="p-8 min-h-screen mx-9">
      ...
      <div className="flex gap-6">
        ...
        <div className="w-64 p-4 border border-gray-200 rounded-lg bg-white shadow-sm">
          <div className="mb-6">
            ...
            <div className="ml-6 space-y-3">
              ...
              >
                <div className="w-3 h-3 border border-blue-500 rounded-full"></div>
                <span className="text-sm text-gray-500">Question 3</span>
              </div>
              <div 
                className="flex items-center space-x-2 cursor-pointer hover:bg-blue-50 p-2 rounded"
        ...
        <div className="flex-1 border border-gray-200 rounded-lg bg-white shadow-sm p-6">
          ...
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-blue-600 mb-2">Question 1</h3>
