...
const QuestionD: React.FC = () => {
  ...
  const examSection: ExamSection = {
    ...
    questions: [
      {
        question: "A store offers a 20% discount on a product that originally costs $200. What is the final price after the discount?",
        type: "Multiple Choice",
        options: ["$160", "$180", "$150", "$140"],
        correctAnswer: "$160"
      }
    ],
    isExpanded: true
    ...
    <div className="p-8 min-h-screen mx-9">
      ...
      <div className="flex gap-6">
        ...
        <div className="w-64 p-4 border border-gray-200 rounded-lg bg-white shadow-sm">
          <div className="mb-6">
            ...
            <div className="ml-6 space-y-3">
              ...
              >
                <div className="w-3 h-3 bg-blue-600 rounded-full"></div>
                <span className="text-sm">Question 4</span>
              </div>
              <div 
        ...
        <div className="flex-1 border border-gray-200 rounded-lg bg-white shadow-sm p-6">
          ...
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-blue-600 mb-2">Question 4</h3>
