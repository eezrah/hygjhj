...
const QuestionB: React.FC = () => {
  ...
  const examSection: ExamSection = {
    ...
    questions: [
      {
        question: "A sequence of numbers follows a specific pattern: 2, 4, 8, 16, 32, ... What is the next number in the sequence?",
    ...
    <div className="p-8 min-h-screen mx-9">
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 border border-gray-200 rounded-lg bg-white shadow-sm p-6">
          ...
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-blue-600 mb-2">Question 2</h3>
